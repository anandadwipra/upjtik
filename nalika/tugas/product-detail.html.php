                    		...
                    		<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<ul id="myTab" class="tab-review-design">
										<li class="active"><a href="#tambahan">tambahan</a></li>
										<li><a href="#reviews"><span></span> reviews <span></span></a></li>
										<li><a href="#lanjutan">lanjutan</a></li>
									</ul>
									<div id="myTabContent" class="tab-content">
										<div class="product-tab-list product-details-ect tab-pane fade active in" id="tambahan">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="product-tab-list tab-pane fade" id="lanjutan">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="review-content-section">
														<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2018 <a href="https://colorlib.com/wp/templates/">BAPEL</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
