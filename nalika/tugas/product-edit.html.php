                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nama Petugas" name="pe_name">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="date" class="form-control" placeholder="Tanggal Maintenance" name="mt_tgl">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nama Access Point" name="mt_name_ap">
                                                    </div>
                                                

                                                    <div class="input-group mg-b-pro-edt form-radio">
                                                        <span class="input-group-addon">= = = = = = Pilih Band = = = = = =</span>
                                                        <div class="radio radiofill">
    <label><input type="radio" class="radio" name="band" value="2GHz" placeholder="2Ghz" checked><i class="helper"></i>2GHz</label></div>
                                                        <div class="radio radiofill">
    <label><input type="radio" class="radio" name="band" value="5GHz"><i class="helper"></i>5GHz</label></div>
                                                    
                                                    
                                                
                                                        <select class="form-control pro-edt-select form-control-primary" name="protocol">
                                                            <option value="Only B">Only B</option>
                                                            <option value="Only G">Only G</option>
                                                            <option value="Only N">Only N</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="STX Signal" name="stx">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="SRX Signal" name="srx">
                                                    </div>                                    

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="CCQ Signal" name="ccq">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <select class="form-control pro-edt-select form-control-primary" name="protocol">
															<option value="belum disetting">Pilih Wireless Protocol  !</option>
                                                    ...
                                                    <textarea class="form-control pro-edt-select form-control-primary" cols="40" rows="2rim" name="mt_comment" placeholder="Ada yang ingin di sampaikan?"></textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds"><br><br>
